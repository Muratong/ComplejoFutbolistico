...
import sesionBeansReservas.RolFacadeLocal;
...
public class RolControlador implements Serializable {
    ...
    public void update() {
        persist(JsfUtil.PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("RolUpdated"));
    }
    ...
    public static class RolControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            RolControlador controller = (RolControlador) facesContext.getApplication().getELResolver().
