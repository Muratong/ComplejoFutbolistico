...
public class CanchaTipo implements Serializable {
    ...
    private Integer canTipCapacidad;
    ...
    public Integer getCanTipCapacidad() {
        return canTipCapacidad;
    }

    public void setCanTipCapacidad(Integer canTipCapacidad) {
    ...
    public String toString() {
        return "entidadesGestion.CanchaTipo[ canTipId=" + canTipId + " ]";
    }
